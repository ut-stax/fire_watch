...
const bruteForceDetection = {
  ...
  evaluate(events, newEvent) {
    ...
    const newEventTime = getTimestampMs(newEvent.timestamp);
...
const credentialStuffing = {
  ...
  evaluate(events, newEvent) {
    ...
    const sourceIP = newEvent.source_ip;
    const successfulLoginTime = getTimestampMs(newEvent.timestamp);
...
const privilegeEscalation = {
  ...
  evaluate(events, newEvent) {
    ...
    const sourceIP = newEvent.source_ip;
    const escTime = getTimestampMs(newEvent.timestamp);
